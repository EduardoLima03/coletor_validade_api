...
<head>
    ...
    <title>Login - ValiCheck {{ $companySetting->company_name ?? 'Medeiros' }}</title>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <h4 class="mb-0">ValiCheck - {{ $companySetting->company_name ?? 'Medeiros' }}</h4>
                ...
                <div class="footer-dc">
                    ValiCheck - Medeiros v{{ config('app.version') }} &mdash;
                    Desenvolvido por
